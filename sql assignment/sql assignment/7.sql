...
SELECT D1.ACTNO,D1.BNAME,D1.AMOUNT,D1.ADATE ,BR1.LOANNO, BR1. BNAME BR1.AMOUNT FROM DEPOSITE D1 BORROW BR1 CUSTOMER C1 WHERE C1.CNAME = D1.CNAME AND D1.CNAME=BR1.CNAME AND C1.CITY IN (SELECT C2.CITY FROM 
...
SELECT C1.CNAME FROM CUSTOMER C1 WHERE C1.CITY IN (SELECT C2. 
