...
SELECT EMP_NO,EMP_SAL, ROUND (EMP_SAL * 1.15) "NEW_SALARY" FROM EMPLOYEE;
SELECT EMP_NO , EMP_SAL, ROUND(EMP_SAL * 1.15) "NEW_SALARY" , (EMP_SAL * 1.15 - EMP_SAL) "INCREASE" FROM EMPLOYEE;
...
SELECT (EMP_NAME || 'EARNS' || EMP_SAL || 'MONTHLY') "INCOME" FROM EMPLOYEE; 
//SELECT EMP_NAME , HIRE_DATE , MONTHS_BETWEEN (SYSDATE , HIRE_DATE) "MONTHS" , EXTRACT (DAY FROM HIRE_DATE) "DAY" FROM EMPLOYEE ORDER BY DAY;
